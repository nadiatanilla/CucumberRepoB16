   ...
   public static byte[] takeScreenshot(String fileName)  {
      ...
      try {
         FileUtils.copyFile(screenShot,
                 new File(Constants.SCREENSHOTS_FILEPATH + fileName + "" + getTimeStand("yyyy-MM-dd-HH-mm-ss") + ".png"));
      }catch (IOException io){
         io.printStackTrace();
      }
return picBytes;
   }
public static String getTimeStand(String pattern){
      //it returns the current date and time in java
      Date date=new Date();
      //this function sdf is used to format the date as per the
